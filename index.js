...
function drawSquare(x, y, color) {
    ...
    // Neon outline - NO SHADOW BLUR to prevent waves
...
function drawBoard() {
    ...
    // Draw all squares from the board
    for (r = 0; r < ROW; r++) {
        for (c = 0; c < COL; c++) {
    ...
    // Draw grid lines - VERY THIN and DARK
    ctx.shadowColor = "transparent";
    ctx.shadowBlur = 0;
...
// Draw neon border - ONLY border, no shadow on blocks
...
// Redraw everything - FULL REDRAW on every move
function fullRedraw() {
    drawBoard();
